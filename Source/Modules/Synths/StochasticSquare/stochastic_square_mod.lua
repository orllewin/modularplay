...
function StochasticSquareMod:tryConnectGhostIn(x, y, ghostCable, sourceSubtype, onError)
...
function StochasticSquareMod:getModId()
	return self.modId
end
...
function StochasticSquareMod:repositionBy(x, y)
	self:moveBy(x, y)
end

function StochasticSquareMod:moveFinish()
